...
(function() {
  var BNP, LOADER, TRM, alert, assert, badge, debug, echo, help, info, log, njs_path, praise, rpr, urge, warn, whisper,
    __slice = [].slice;
  ...
  this.main = function() {
    var TESTS, error, fail_count, idx, locator, m, matchers, miss_count, module, module_name, nr, pass_count, route, route_count, route_info, route_infos, skip_count, test_count, test_name, test_names, _i, _j, _k, _len, _len1, _len2, _ref;
