...
(function() {
  ...
  this.main = function() {
    var TESTS, error, fail_count, idx, locator, m, matchers, miss_count, module, module_name, nr, pass_count, route, route_count, route_info, route_infos, skip_count, test_count, test_name, _i, _j, _len, _len1, _ref;
    ...
    for (_j = 0, _len1 = route_infos.length; _j < _len1; _j++) {
      ...
      if ((TESTS = (_ref = module['$TESTS']) != null ? _ref : module['tests']) == null) {
        miss_count += 1;
