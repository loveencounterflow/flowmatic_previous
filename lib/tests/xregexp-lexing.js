...
(function() {
  ...
  * ncr
  ...
  TAP.test("basic model", function(T) {
    var i, len, matcher, probe, probes_and_matchers, result, splitter;
    debug('-----------------------------------------------');
    debug("basic model");
    debug('-----------------------------------------------');
  ...
  TAP.test("Unicode categories (1)", function(T) {
    var i, len, matcher, probe, probes_and_matchers, result, splitter, tokens;
    debug('-----------------------------------------------');
  ...
  TAP.test("Unicode categories (2)", function(T) {
    var alias, i, j, len, len1, matcher, name, probe, probes_and_matchers, result, splitter, tokens, x;
    debug('-----------------------------------------------');
