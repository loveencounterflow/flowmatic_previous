...
(function() {
  ...
  * ncr
  ...
  f = function() {
    ...
    this.$prepare.$as_lines = (function(_this) {
      return function() {
    ...
    this.$prepare.$as_line_events = (function(_this) {
      return function() {
    ...
    this.$prepare.$add_positions = (function(_this) {
      return function() {
        var x, xx, y;
        y = -1;
        x = 0;
    ...
    this.$prepare.$add_chunks = (function(_this) {
      return function() {
    ...
    this.$prepare.$recognize_fncrs = function() {
      ...
      return PS.map(function(event) {
        ...
        for (i = 0, len = source_chunks.length; i < len; i++) {
          ...
          image = source_chunk.image, y = source_chunk.y, x = source_chunk.x;
          is_plain = false;
          xx = x;
    ...
    this.$prepare.$as_chrs = (function(_this) {
      return function() {
        return PS.map(function(event) {
          ...
          for (i = 0, len = source_chunks.length; i < len; i++) {
            ...
            y = source_chunk.y, x = source_chunk.x;
    ...
    this.$group_chrs_by_ucc.$add_uccs = (function(_this) {
      return function() {
        return PS.map(function(event) {
          var chunk, i, len, ref;
          if (event.type !== 'line') {
    ...
    this.$identifiers.$add_identifier_type = (function(_this) {
      return function() {
        return PS.map(function(event) {
          var chunk, i, idx, len, ref;
          if (event.type !== 'line') {
    ...
    this.$identifiers.$group_identifiers = (function(_this) {
      return function() {
        return PS.map(function(event) {
    ...
    this.$finalize.$update_line_target = (function(_this) {
      return function() {
        return PS.map(function(event) {
          var chunk;
          if (event.type !== 'line') {
  ...
  g = function() {
    this.new_chunk = function() {
      var P, R;
      P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      R = Object.assign.apply(Object, [{}].concat(slice.call(P)));
      if (R.target == null) {
        R.target = R.image;
      }
      return R;
    };
    return this.merge_chunks = function() {
      var P, R, a, b, ref;
      a = arguments[0], b = arguments[1], P = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      R = (ref = FM.U).new_chunk.apply(ref, [a].concat(slice.call(P)));
      if (b == null) {
        return R;
      }
      if (a.y !== b.y) {
  ...
  TAP.test("stress test", function(T) {
    var input, output, path, pipeline;
    ...
    pipeline.push(PS.map(function(event) {
      return event.target + '\n';
    }));
