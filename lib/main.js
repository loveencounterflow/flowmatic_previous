...
(function() {
  var MULTIMIX, TRM, alert, badge, debug, echo, help, info, log, module, name, njs_path, nr, rainbow, route, route_info, route_infos, rpr, warn, whisper, ƒ, π, _i, _len,
    __slice = [].slice;
  ...
  this.as.coffee = function(node) {
    ...
    var grammar, taints, target, translator, type;
    ...
    target = node['value'] != null ? rpr(node['value']) : rpr(node);
    taints = {};
